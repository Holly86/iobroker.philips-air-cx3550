...
const NAME_MAPPING = {
    ...
    // Philips CX3550/01 / Trident fan (Versuni HomeID generation).
    // Kept as CX-prefixed friendly states to avoid sending legacy air-purifier keys such as pwr/om
    // to fan devices when users control the fan.
